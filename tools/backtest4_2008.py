...
TEST_DATES = [
    datetime(2008,8,25), datetime(2008,9,1), datetime(2008,9,11), datetime(2008,9,19),
    datetime(2008,10,7), datetime(2008,10,15), datetime(2008,10,31), datetime(2008,11,11),
    datetime(2008,11,24), datetime(2008,12,4), datetime(2008,12,12), datetime(2008,12,22),
    datetime(2009,1,6), datetime(2009,1,16), datetime(2009,1,27), datetime(2009,2,10),
    datetime(2009,2,17), datetime(2009,3,2), datetime(2009,3,16), datetime(2009,3,25),
]
...
def build_historical_state(as_of_date):
    ...
    state = {
        ...
        "mining_supply_growth": "Mining Supply Growth: Data unavailable (backtest - 2008 predates historical text recovery)",
        "solar_panel_demand": "Solar Panel Demand: Data unavailable (backtest - 2008 predates historical text recovery)",
        "geopolitical_risk": "Geopolitical Risk: Data unavailable (backtest - 2008 predates historical text recovery)",
    }
...
def run_backtest():
    ...
    df.to_csv("backtest4_2008_results.csv", index=False)
    ...
    print("\nSaved to backtest4_2008_results.csv")
