...
# Same 40 dates used for GoldBot's Backtest 1 expansion, for cross-bot comparability
TEST_DATES = [
    datetime(2025,9,9), datetime(2025,9,22), datetime(2025,10,13), datetime(2025,10,28),
    datetime(2025,11,7), datetime(2025,11,24), datetime(2025,12,5), datetime(2025,12,22),
    datetime(2026,1,5), datetime(2026,1,26), datetime(2026,2,3), datetime(2026,2,26),
    datetime(2026,3,4), datetime(2026,3,20), datetime(2026,4,3), datetime(2026,4,27),
    datetime(2026,5,6), datetime(2026,5,22), datetime(2026,6,8), datetime(2026,6,23),
    datetime(2025,9,11), datetime(2025,9,25), datetime(2025,10,7), datetime(2025,10,20),
    datetime(2025,11,10), datetime(2025,11,28), datetime(2025,12,9), datetime(2025,12,29),
    datetime(2026,1,1), datetime(2026,1,22), datetime(2026,2,4), datetime(2026,2,23),
    datetime(2026,3,10), datetime(2026,3,30), datetime(2026,4,8), datetime(2026,4,28),
    datetime(2026,5,7), datetime(2026,5,18), datetime(2026,6,9), datetime(2026,6,25),
]
...
def run_backtest():
    ...
    df.to_csv("backtest1_expansion_results.csv", index=False)
    ...
    print("\nSaved to backtest1_expansion_results.csv")
